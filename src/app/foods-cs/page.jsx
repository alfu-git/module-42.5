...
import NoFood from "../components/shared/NoFood";
...
const foodsData = [
  ...
  },
  {
    ...
    cuisine: "American",
    origin_and_popularity:
      "Classic American fast food, originated in the United States in the early 20th century. Extremely popular worldwide including Bangladesh.",
    cooking_steps: [
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1774363086/foods/afe49ef1-da8a-48d1-8a2c-e92803127253.png",
    rating: 4.7,
    price: 450,
  },
  {
    ...
    origin_and_popularity:
      "Popular American-style fast food item, widely loved in Bangladesh through local cafes, burger chains, and delivery apps.",
    cooking_steps: [
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1774363416/foods/adfc835d-b05f-46c7-a095-5f3c4d54769b.png",
    rating: 4.6,
    price: 480,
  },
  {
    ...
    origin_and_popularity:
      "Originated from American diner culture (popularized by Oklahoma-style smash burgers). Currently one of the most trending burger styles worldwide, including in Dhaka's gourmet burger cafes.",
    cooking_steps: [
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1774363673/foods/9b817a26-f391-46f3-bf3f-b907df8032b2.png",
    rating: 4.8,
    price: 520,
  },
  {
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1774364206/foods/abdb7caa-c84b-4a9e-9d1d-5805b9e155c7.png",
    rating: 4.9,
    price: 750,
  },
  {
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1774364339/foods/c6a7a9c8-a223-4180-ad7d-3d86b3396b6c.png",
    rating: 4.8,
    price: 620,
  },
  {
    ...
    origin_and_popularity:
      "Classic American beverage, extremely popular worldwide as a refreshing and indulgent drink. Very common in Dhaka cafes, burger joints, and dessert shops.",
    cooking_steps: [
  ...
  },
  {
    ...
    origin_and_popularity:
      "Popular refreshing beverage in Bangladesh cafes, juice bars, and fast food outlets. Loved for its natural sweetness and fruity flavor, especially during summer.",
    cooking_steps: [
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1774364825/foods/0efa01ea-3ba4-4291-b5c3-1ca069e3e4af.png",
    rating: 4.6,
    price: 290,
  },
  {
    ...
    cuisine: "American / International",
    origin_and_popularity:
      "Beloved classic chocolate beverage, extremely popular in Dhaka cafes, burger joints, and dessert shops. A go-to indulgent drink for chocolate lovers.",
    cooking_steps: [
    ...
    image_link:
      "https://res.cloudinary.com/dj493l0jy/image/upload/v1774364933/foods/46e6bcf8-3dc8-4d21-9dbc-95ea95f371d9.png",
    rating: 4.8,
    price: 340,
  },
];
        ...
        <div>
          ...
          <div className="mb-6 max-w-5xl mx-auto p-3 bg-[#212121] rounded-lg flex gap-4 justify-between items-center">
            ...
            <div className="flex gap-4 items-center">
              <button className="btn shadow-none border-none px-6 h-12.5 bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white rounded-xl font-medium">
                Search
              </button>
